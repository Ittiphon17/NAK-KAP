...
export function FilterSidebar({ dict }: FilterSidebarProps) {
  return (
    <aside className="w-full lg:w-72 space-y-10">
      <div>
        <h3 className="text-lg font-bold text-primary mb-6">{dict.filters.priceRange}</h3>
      ...
      <div>
        <h3 className="text-lg font-bold text-primary mb-6">{dict.filters.carType}</h3>
        <div className="space-y-3">
          {dict.filters.carTypeOptions.map((type) => (
      ...
      <div>
        <h3 className="text-lg font-bold text-primary mb-6">{dict.filters.transmission}</h3>
        <div className="flex gap-2">
          {dict.filters.transmissionOptions.map((t) => (
      ...
      <div>
        <h3 className="text-lg font-bold text-primary mb-6">{dict.filters.seats}</h3>
        <div className="grid grid-cols-2 gap-2">
          {dict.filters.seatOptions.map((s) => (
